...
Name:           ros-eloquent-ament-cmake-pep8
Version:        0.8.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS ament_cmake_pep8 package

License:        Apache License 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-eloquent-ament-cmake-test
Requires:       ros-eloquent-ament-pep8
Requires:       ros-eloquent-ros-workspace
BuildRequires:  ros-eloquent-ament-cmake-copyright
BuildRequires:  ros-eloquent-ament-cmake-core
BuildRequires:  ros-eloquent-ament-cmake-lint-cmake
BuildRequires:  ros-eloquent-ament-cmake-test
...
%description
The CMake API for ament_pep8 to check code against the style conventions in PEP
8.
